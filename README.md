...
---
![Main workflow](https://github.com/hillel-i-python-pro-i-2022-08-26/homework__django__V.Marakhovskyi/actions/workflows/main-workflow.yml/badge.svg?branch=crud_drf)
...
Updating existed Django project with CRUD ops using DRF.
Set restriction for any changes and views only for auth users.
